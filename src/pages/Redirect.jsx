...
export default function Redirect() {
  ...
  if (error) return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-4 font-body">
      ...
      <h1 className="text-2xl font-sora font-bold text-ink">קישור לא נמצא</h1>
      <p className="text-gray-400 text-sm">הקישור לא קיים או פג תוקפו</p>
      <a href="/" className="mt-4 text-drop text-sm font-medium hover:underline">חזרה לדף הבית</a>
    </div>
  )
